...
In other words, you don't need to write tags for classes.
...
You need to write configurations. All configurations are [here](./configuration.html#full-config).
...
If you use asset(image) for manual, you can specify asset directory path.
```json
{
  "source": "./src",
  "destination": "./doc",
...
If you write index of manual, you can specify index file path.
```json
{
  "source": "./src",
  "destination": "./doc",
...
If you use manual as documentation index, you can specify global index.
```json
{
  "source": "./src",
  "destination": "./doc",
...
All configurations are [here](./configuration.html#full-config).
...
And, ESDoc supports plugin feature. Please read [API](/api.html) for more information.
