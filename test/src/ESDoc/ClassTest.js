...
//    let docs = db.find({name: 'staticMethod1', kind: 'method', memberof: classDoc.longname});
//    assert.equal(docs.length, 1);
//    assert.doc(docs[0],
//    {
//      "kind": "method",
...
//    let docs = db.find({name: 'p1', kind: 'member', static: true, memberof: classDoc.longname});
//    assert.equal(docs.length, 1);
//    assert.doc(docs[0],
//    {
//      "kind": "member",
...
//
//  it('has method.', ()=>{
//    let docs = db.find({kind: 'method1', name: 'method', memberof: classDoc.longname});
//    assert.equal(docs.length, 1);
//    assert.doc(docs[0],
//    {
//      "kind": "method",
...
//    let docs = db.find({kind: 'method', name: 'method2', memberof: classDoc.longname});
//    assert.equal(docs.length, 1);
//    assert.doc(docs[0],
//    {
//      "kind": "method",
...
//    let docs = db.find({kind: 'method', name: 'method3', memberof: classDoc.longname});
//    assert.equal(docs.length, 1);
//    assert.doc(docs[0],
//    {
//      "kind": "method",
